class Pantallas {
  constructor() {
    this.pantallaActual = 0; // Pantalla inicial
    this.J = new juego(); // Asegúrate de que la clase juego esté inicializada
    ...
    if (this.J.ganaste) {
      this.pantalla = 5;
       image(p[5], 0, 0, 600, 600);
        ...
        this.bot7.dibujarBoton(3, 4);// Cambia a la pantalla de victoria
    }
  }
